...
image: fun
	...
	@rm -rf root tmp
	@mv images/sdcard.img images/FunKey-sdcard-DrUm78_game-de-it_FunKey-S.img
...
image-prod: fun
	...
	@rm -rf root tmp
	@mv images/sdcard-prod.img images/FunKey-sdcard-prod-DrUm78_game-de-it_FunKey-S.img
...
update: fun
	...
	tr " " "\n" | \
	cpio -o -H crc --quiet > ../images/FunKey-rootfs-DrUm78_game-de-it_FunKey-S.fwu
	@rm -rf tmp
